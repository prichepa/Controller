...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670889, ; uint32_t jnienv_initialize_method_token (0x6001da9)
	i32 100670888, ; uint32_t jnienv_registerjninatives_method_token (0x6001da8)
...
@dso_cache = dso_local local_unnamed_addr global [486 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4264085783498378423, ; hash 0x3b2d136d9136ccb7, from name: Controller
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Controller.dll.so
		ptr null; void* handle (0x0)
	}, ; 110
	%struct.DSOCacheEntry {
		i64 4377539647393221538, ; hash 0x3cc0251db90fcba2, from name: Controller.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Controller.dll.so
		ptr null; void* handle (0x0)
	}, ; 111
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.21_name, ; name: libaot-Plugin.BLE.dll.so
		ptr null; void* handle (0x0)
	}, ; 123
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6644424769550896185, ; hash 0x5c35bd1fcde34c39, from name: aot-Controller
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Controller.dll.so
		ptr null; void* handle (0x0)
	}, ; 151
	...
	%struct.DSOCacheEntry {
		i64 11017740688954840829, ; hash 0x98e6e0c8388556fd, from name: aot-Controller.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Controller.dll.so
		ptr null; void* handle (0x0)
	}, ; 276
	...
	%struct.DSOCacheEntry {
		i64 12982895415917625281, ; hash 0xb42c82982dd13fc1, from name: libaot-Controller.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Controller.dll.so
		ptr null; void* handle (0x0)
	}, ; 336
	...
	%struct.DSOCacheEntry {
		i64 13821326751055989261, ; hash 0xbfcf3773994bca0d, from name: libaot-Controller
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Controller.dll.so
		ptr null; void* handle (0x0)
	}, ; 362
...
@.env.3 = private unnamed_addr constant [37 x i8] c"176b09fb-f030-47ac-abf4-3ac546464a01\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.controller\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-Controller.dll.so\00", align 16
...
@.DSOCacheEntry.21_name = private unnamed_addr constant [25 x i8] c"libaot-Plugin.BLE.dll.so\00", align 16
